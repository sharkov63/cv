...
I have good programming skills in C++, Kotlin, Python languages. My selected projects:

\indent

\cvlistitem{\textbf{c-daikon-tracer}: an LLVM frontend for \href{https://plse.cs.washington.edu/daikon/}{\color{blue} \texttt{Daikon}} dynamic program invariant detection system. At the moment this tool is WIP.}
...
\section{Education}
~
\cventry{2021--2025}{B.Sc.~programme ``Modern Software Engineering''}{St. Petersburg State University, Department of Mathematics and Computer Science}{}{}{At the moment (2022-2023) I am a second-year Bachelor student.}
...
\cvlistitem{Dynamic invariant detection}
\cvlistitem{Symbolic execution}

\section{Other}

\subsection{Amateur Game Developing in Unity (JS, C\#)}
