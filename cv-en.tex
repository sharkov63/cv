...
\cvlistitem{Team Kotlin project during the first year of undergraduate: \textbf{sport management system}. A program which helps organising competitions of certain sports, such as sprinting, orienteering, etc. }
...
In school I used to do \textit{speedrunning} --- attempting to complete certain video games as fast as possible. Aside from real-time speedrunning, I was the head of the following projects.
